...
namespace methods_2
{
    public class Ogrenci //classımızı bütün uygulama içerisinde kullanabilmek için public olarak işaretliyeceğiz(bunlara erişim belirleyici deniliyor)
    {
        ...
        //geri dönüş değerimin herhangi bir şey olmasını istemiyorum.Herhangi bir geri dönüş değerine sahip olmicaksa metotlarımız bir işlemi yapıp sonlanıcaksa o zaman geri dönüş değerine void olarak yazıyoruz.
